...
Since $\mfq_1\cap A=\mfp_1$ we can think $\ovB$ as an extension ring of $\ovA$. Hence by the Proposition in integral over we have $\ovB$ integral over $\ovA$. Hence by the previous theorem there exists a prime ideal $\overline{\mfq}_2$ in $\ovB$ such that $\overline{\mfq_2}\cap \ovA=\overline{\mfp_2}$ where $\overline{\mfp_2}$ is the image of $\mfp_2$ in $\ovA$. Hence the lift back of $\overline{\mfq_2}$ to $B$ we have a prime ideal $\mfq_2$ with the required property.
