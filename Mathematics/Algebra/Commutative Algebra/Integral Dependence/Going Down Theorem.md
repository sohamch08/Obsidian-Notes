...
---
>[!theorem] heorem (Going Down Theorem)
...
Let $x\notin \mfp_2$. Then by $x^i v_i=u_i\in \mfp_2$ we have each $v_i\in\mfp_2$. Hence by the minimal polynomial of $s$ it shows that $s^r\in B\mfp_2 \subeq B\mfp_1\subeq \mfq_1$ and hence $s\in \mfq_1$. Contradiction. Therefore $x\in \mfp_2$. Therefore $B_{\mfq_1}\mfp_2\cap A=\mfp_2$ as required.
